...
export const PERMISSION_RESOURCE = {
  ...
  systemGitlab: '/system/third-party/gitlab',
  asset: '/asset',
  ...
  systemGitlabSave: '/system/third-party/gitlab/save',
  systemGitlabTestConnection: '/system/third-party/gitlab/test-connection',
  systemGitlabProjects: '/system/third-party/gitlab/projects',
  assetCategoryManage: '/asset/category/manage',
  assetCategoryDelete: '/asset/category/delete',
