...
export const PERMISSION_RESOURCE = {
  ...
  assetDeviceManage: '/asset/device/manage',
  assetDeviceReceive: '/asset/device/receive',
  assetDeviceReturn: '/asset/device/return',
  assetDeviceTransfer: '/asset/device/transfer',
  assetDeviceScrap: '/asset/device/scrap',
  assetLocationManage: '/asset/location/manage',
  assetStocktakeManage: '/asset/stocktake/manage',
