...
export const PERMISSION_GROUP_SHORTCUTS: PermissionGroupShortcut[] = [
  ...
  },
  {
    ...
    description: '设备台账页与动作弹窗实际调用的接口。',
  },
  {
    code: 'ASSET_LOCATION_DEPENDENCIES',
    name: '设备位置管理依赖接口',
    triggerResources: [PERMISSION_RESOURCE.assetLocationManage],
    apiResources: [
      '/asset/location/list',
      '/asset/location/create',
      '/asset/location/edit',
    ],
    description: '设备位置管理实际调用的接口。',
  },
  {
    code: 'ASSET_STOCKTAKE_DEPENDENCIES',
    name: '设备盘点任务依赖接口',
